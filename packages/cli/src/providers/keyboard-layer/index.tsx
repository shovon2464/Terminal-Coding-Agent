...
type KeyboardLayerProviderProps = {
    children: ReactNode;
}

export function KeyboardLayerProvider({ children }: KeyboardLayerProviderProps) {
...
export function useKeyboardLayer() {
    ...
    if (!context) {
        throw new Error("userKeyboardLayer must be used within a KeyboardLayerProvider");
    }
    return context;
}